 ...
 * @author Gayali
 */
public class UserSensorDetails extends javax.swing.JFrame{

    /**
     * Creates new form UserSensorDetails
     */
    public UserSensorDetails() {
        initComponents();
        showSensorDetails();
        DetailsUpdate();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UserSensorDetails.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UserSensorDetails().setVisible(true);
            }
        });
    }
